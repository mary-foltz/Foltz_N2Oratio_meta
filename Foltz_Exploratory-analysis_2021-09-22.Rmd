---
title: "Foltz_Exploratory-analysis_2021-09-22"
output:
...
```{r}
nr <- read_excel('N2O ratio database_2021-09-22.xlsx', sheet = "database", na =  c("NA", "NR"))
head(nr)
names(nr)
...
```{r}
rf <- randomForest(nr_trt_mean ~ ., data = nr2, weights = nr_n)
rf
varImpPlot(rf)
```
